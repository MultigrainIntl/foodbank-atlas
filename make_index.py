...
<div class="wrap">
 ...
 · Rank correlation between the equal-weighted and data-weighted scores: <b>0.999</b> in both countries.<br>
 ...
 <p><b>Missing-data rule: holds.</b> Dropping any single indicator and rescoring changes the neighbourhood ranking very little: rank correlation with the full score stays between 0.90 and 0.99 in Canada and between 0.96 and 1.00 in the United States. This is direct evidence that the neighbourhoods scored on fewer indicators (section 4) are not badly misplaced.</p>
